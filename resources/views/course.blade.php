...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_background_container prlx_parent">
            <div class="home_background prlx" style="background-image:url('https://source.unsplash.com/iWTamkU5kiI')"></div>
        </div>
                            ...
                            <div class="news_post_top d-flex flex-column flex-sm-row">
                                ...
                                <div class="news_post_title_container">
                                    <div class="news_post_title">
                                        <a href="news_post.html">{{$data->name}}</a>
                                    </div>
                                    <div class="news_post_meta">
                                        <span class="news_post_author"><a href="#">By {{$data->teacher_name}}</a></span>
                                        <span>|</span>
